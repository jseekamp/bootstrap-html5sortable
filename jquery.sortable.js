    ...
    $.fn.sortable = function (options) {
      ...
      return this.each(function () {
        ...
        var placeholder = $('<' + (/^ul|ol$/i.test(this.tagName) ? 'li' : /^tbody$/i.test(this.tagName) ? 'tr' : 'div') +
                            ' class="sortable-placeholder ' + options.placeholderClass + '">').html(options.placeholderHtml);
        ...
        items.attr('draggable', 'true').on('dragstart.h5s', function (e) {
          ...
          if (items.is(this)) {
            ...
            if(options.hideDragSource)
                ...
                $(this)[$(this).index() < dragging.index() ? 'before' : 'after'](placeholder);
